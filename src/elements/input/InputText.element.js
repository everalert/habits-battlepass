export default function InputText({ text, setParentText, onFocus, onBlur }) {

	return (
		<label className="h-7 flex items-center px-2 rounded text-zinc-600 caret-zinc-500 bg-zinc-300">
