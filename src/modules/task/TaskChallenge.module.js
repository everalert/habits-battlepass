...
export default function TaskChallenge(props) {
	...
	return (
		<div className="clear-both flex flex-row-reverse gap-x-2">
			<div className="text-lg font-medium text-zinc-400 bg-zinc-900 rounded-md text-center tracking-tighter w-16 h-8 pt-[0.08rem] shrink-0"><ItemNumber num={props.reward} /></div>
			<div className="flex-grow relative">
				...
				<span className="text-sm absolute top-0 right-0 pl-8 bg-gradient-to-r from-transparent via-black to-black">
					<span className="text-base font-bold"><ItemNumber num={props.over} /></span>
					<span>/</span>
